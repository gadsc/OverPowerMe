...
<body style="font-family: Arial, Verdana; background-color: #fff;">
	...
	<div id="slider1_container"
		...
		<div u="slides"
			...
			<div>
				<img u="image" src="resources/img/landscape/05.jpg" />
			</div>
			<div>
				<img u="image" src="resources/img/landscape/06.jpg" />
			</div>
			<div>
				<img u="image" src="resources/img/landscape/07.jpg" />
			</div>
			<div>
				<img u="image" src="resources/img/landscape/08.jpg" />
			</div>
		</div>
...
.jssora03l { background-position: -10px -40px; }
.jssora03r { background-position: -70px -40px; }
.jssora03l:hover { background-position: -130px -40px; }
.jssora03r:hover { background-position: -190px -40px; }
.jssora03ldn { background-position: -250px -40px; }
.jssora03rdn { background-position: -310px -40px; }
</style>
		<!-- Arrow Left -->
